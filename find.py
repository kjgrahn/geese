#!/usr/bin/python
# -*- coding: iso-8859-1 -*-
# $Id: find.py,v 1.7 2004-08-05 17:35:00 grahn Exp $
...
if __name__ == "__main__":
    ...
    class test(unittest.TestCase):
        ...
        def testJala(self):
            p1 = find([(6436000, 1360000, 4206), (6436000, 1360000, 4206),
            ...
            self.assertClose(p1, p3)
            self.assertClose(p2, p3)
        def testMonarp(self):
            p1 = find([(6440000, 1362000, 4415), (6440000, 1364000, 4405),
        ...
        def testMonarpMonarp(self):
            p1 = find([(6440000, 1362000, 3962), (6440000, 1364000, 3546),
        ...
        def testSmula(self):
            ...
            p2 = find([(6440000, 1366000, 4464), (6440000, 1366000, 4464),
                       (6440000, 1368000, 3709), (6440000, 1368000, 3709),
                       (6440000, 1370000, 3949), (6440000, 1370000, 3949),
                       (6440000, 1372000, 5042)])
            self.assertClose(p1, p2)
        def testTornarp(self):
            p1 = find([(6436000, 1360000, 4092), (6436000, 1360000, 4092),
                       (6436000, 1362000, 4176), (6436000, 1362000, 4176),
                       (6436000, 1364000, 5112)])
            p2 = find([(6436000, 1356000, 6273), (6436000, 1356000, 6273),
                       (6436000, 1358000, 4904), (6436000, 1358000, 4904),
                       (6436000, 1360000, 4092), (6436000, 1360000, 4092)])
            self.assertClose(p1, p2)
        def testVarnum(self):
            p1 = find([(6440000, 1346000, 6528), (6440000, 1348000, 6214),
        ...
        def testAsarp(self):
            ...
            p2 = find([(6440000, 1366000, 4706), (6440000, 1368000, 4415),
