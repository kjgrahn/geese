...
Rikets Nät projection (also known as the Swedish Grid) appearing as a
square grid with origo to the south-west of Sweden on many national
high-resolution maps, and pixel coordinates in bitmap images generated
by scanning a part of such a map. Obviously, such scanned images are
scaled and translated relative to the Rikets Nät, and if the scan
isn't perfect they tend to be slightly rotated as well.
